...
class PublicationController extends AbstractController
{
    ...
    /**
     * @Route("/adminz/new", name="admin_pubb_new", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("adminz/show/{id}", name="app_pubb_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/adminz/{id}", name="Admin_Delete", methods={"POST"})
     */
    ...
    /**
     * @Route("/d/{id}", name="app_pubb_delete", methods={"POST"})
     */
